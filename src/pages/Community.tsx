        ...
        <header className="border-b bg-card sticky top-0 z-10">
          <div className="container mx-auto px-4 py-6">
            <div className="flex items-center justify-between">
              <div>
                <h1 className="text-3xl font-bold text-foreground mb-2">Travel Community</h1>
                <p className="text-muted-foreground">Share experiences, tips, and connect with travelers</p>
              </div>
              <Dialog>
                ...
                <DialogContent>
                  <DialogHeader>
                    ...
                    <DialogDescription>
                      Upload a photo and share your travel story with the community
                    </DialogDescription>
                  </DialogHeader>
